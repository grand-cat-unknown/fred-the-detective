...
static func _build_suspects() -> Array[SuspectData]:
	return [
		...
		SuspectData.new(
			...
			ROOM_LOBBY, Vector2(176.0, 464.0),
		...
		SuspectData.new(
			...
			ROOM_CONCIERGE, Vector2(176.0, 112.0),
...
static func _build_clues() -> Array[ClueData]:
	return [
		ClueData.new(
			...
			ROOM_SUITE, Vector2(560.0, 400.0),
		),
		ClueData.new(
			CLUE_PEDESTAL,
			"Empty Idol Pedestal",
			...
			ROOM_SUITE, Vector2(624.0, 400.0),
		),
		ClueData.new(
			...
			ROOM_SUITE, Vector2(528.0, 464.0),
		),
		ClueData.new(
			CLUE_FIELD_BOOK,
			...
			ROOM_SUITE, Vector2(656.0, 464.0),
		),
		ClueData.new(
			CLUE_ROOM_1220_LOG,
		...
		ClueData.new(
			...
			ROOM_CHUTE, Vector2(368.0, 464.0),
			[CLUE_CHUTE_NOTICE] as Array[StringName],
			[SUSPECT_WALTER] as Array[StringName],
		),
		ClueData.new(
