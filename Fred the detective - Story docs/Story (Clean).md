...
- **The Personality:** Highly disorganized and anxious. He assumes any missing gear is his own fault.
- **The Testimony:** "I’m a total klutz today. I think I left that cell in the van or packed it wrong. My bags are a mess."
...
Player reference for technical contradictions:

### **Section 5.3: Surface Residue vs. Pigment**

**Surface Residue:** Found on walls/floors. Water-soluble; can be removed with standard soap or alcohol wipes.

**Purge Pigment:** A chemical tracer inside cells. Under high-pressure (Manual Purge), it is forced **sub-dermally** into skin cells. It is permanent for 48-72 hours and cannot be washed off.
...
- **9:07 – 9:09 PM:** Pemberton kills Vance with the stolen Siren Cell, takes the Anchor Idol, then stages the haunting — slamming furniture, simulating a Class-5 manifestation. The noise carries into the hallway, where Mara (now back from 1218) and Thorne (stepping out of 1222) start converging on the front door.
- **9:10 PM:** Pemberton drops the spent cell down the laundry chute via the back service door (**The Thud**), then slips out the same way he came in.
...
5. He pronounces Vance dead — "the idol attracted exactly what we were here to contain" — and the team believes their own doctor.
